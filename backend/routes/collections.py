...
if all([CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET]):
    try:
        ...
        print("[CLOUDINARY] Configured successfully for collections.")
    except Exception:
        CLOUDINARY_ENABLED = False
        print("[CLOUDINARY] Failed to configure Cloudinary for collections.")
else:
    CLOUDINARY_ENABLED = False
    print("\n" + "="*80)
    print("WARNING: [CLOUDINARY] Credentials missing in environment variables.")
    print("WARNING: Gracefully falling back to local file storage for collection image uploads.")
